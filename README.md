...
![ソフトウェアの準備](attachments/fig1-2.png)
...
![シリアルポート選択](attachments/fig3-3.png)

#### 3.3.5. ステップ4: コンパイルとアップロード（書き込み）

1. ツールバーの**検証ボタン**（✓マーク）をクリックしてコンパイル
   ![検証ボタン](attachments/fig3-4.png)
...
2. ツールバーの**アップロードボタン**（→マーク）をクリック
   ![アップロードボタン](attachments/fig3-5.png)
...
![Lesson3 シリアルモニター](attachments/fig5-3.png)
