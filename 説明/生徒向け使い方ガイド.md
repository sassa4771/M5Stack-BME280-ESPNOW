...
10. [10. よくあるエラーと解決方法](#10-よくあるエラーと解決方法)
...
- **Visual Studio Code**（Pythonのプログラムを動かすのに使用）

![ソフトウェアの準備](attachments/画像3.png)
...
> ![アップデートの表示対処方法](attachments/画像4.png)
...
![Arduino IDE画面](attachments/fig1-2.png)
...
![シリアルモニター画面](attachments/fig2-4.png)
...
A: [10. よくあるエラーと解決方法](#10-よくあるエラーと解決方法)のセクションを確認してください。
...
![M5StickC PlusとBME280](attachments/fig3-1.jpg)
...
![Lesson1 ファイルを開く](attachments/fig3-2.png)
...
![シリアルポート選択](attachments/fig3-4.png)

#### 3.3.4. ステップ4: コンパイルとアップロード

1. **スケッチ > 検証/コンパイル**をクリック（または`Ctrl+R`/`Cmd+R`）
   - 画面下部に「コンパイルが完了しました」と表示されればOK
   - エラーが出た場合は、[10. よくあるエラーと解決方法](#10-よくあるエラーと解決方法)を確認してください
...
**作成結果**
![Lesson1 実行結果](attachments/fig3-5.png)
...
![ESP-NOW通信の構成](attachments/fig5-1.png)
...
![Lesson3 動作確認](attachments/fig5-3.jpg)
...
### 10.3. エラー3: 「コンパイルエラー: 'M5StickCPlus' was not declared」
...
### 10.4. エラー4: 「アップロードエラー: Failed to connect to ESP32」
...
### 10.6. エラー6: 「データが受信されない」（lesson3, lesson7）
...
1. エラーメッセージをよく読む
2. [11. よくあるエラーと解決方法](#11-よくあるエラーと解決方法)を確認
3. 講師や周りの人に聞く
4. コードのコメントを読む（`//`で始まる行）
